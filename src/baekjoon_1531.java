...
public class baekjoon_1531 {
    public static void main(String[] args) throws IOException {
        ...
        for(int i=0; i<n; i++){
             ...
             * 21 21 80 80 
             * 41 41 60 60 
             * 까지 계산해보면, 41 41 60 60 부분이 겹침. 즉 20*20 부분은 그림이 안보임.
             * 71 71 90 90 까지 껴본다면, 71 71 80 80 까지가 겹침. 즉, 10*10부분은 그림이 안보임.
             * 겹치는 부분은, 머리로 그려보면 판단이 쉬움. 41 41 60 60, 71 71 80 80 까지가 겹치는 부분.
             * 이걸 코드로 구현하기 위해선 어떻게 해야할까? 21 21 80 80 까지 펼쳐놓고, count ++.
             * 그 다음 좌표를 펼쳐놓고, 겹치는 부분만 count ++.
             * 마지막 좌표도 펼쳐놓고, 겹치는 부분만 count ++. 
             * count로 하는건 구현이 어려울 것 같음. 
             */
